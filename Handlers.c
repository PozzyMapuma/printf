 ...
 * Return: Number the of characters printed.
 */
 ...
 * @ind: Index at which number starts on the buffer
 * @buffer: the Buffer of array
 * @flags: the Flags
 * @width: get the width
